(function () {
	...
	var Menu = function Menu(_ref) {
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "menu"
	  }, path == 'docs' ? /*#__PURE__*/React.createElement("div", {
	    className: "switcher"
	  ...
	  }))) : null, /*#__PURE__*/React.createElement("ul", null, menu.map(function (item, idx) {
	...
	var Footer = function Footer() {
	  ...
	  var pkgName = context.pkgJson.name;
	  return /*#__PURE__*/React.createElement("footer", null, /*#__PURE__*/React.createElement(Badges, null), /*#__PURE__*/React.createElement("div", null, pkgName + " is sharpened by ", /*#__PURE__*/React.createElement(Company, {
	    company: company,
	    url: url
	...
	var getMenuItemYCoordinate = function getMenuItemYCoordinate(item) {
	...
	var getMenuCoordinates = function getMenuCoordinates(menu) {
	  var coords = menu.map(function (e, idx) {
	    var y = getMenuItemYCoordinate(e);
	    return {
	      index: idx,
	      id: e.node.id,
	      y: y
	...
	var findActiveOption = function findActiveOption(menu) {
	  var aOption = undefined;
	  if (menu.length > 0) {
	    var screenTop = window.pageYOffset;
	    var screenHeight = (window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight) - MENU_OFFSET;
	    var screenBottom = screenTop + screenHeight;

	    // console.log(`scr ${screenTop} -> ${screenBottom} (${screenHeight}) `)

	    var coords = getMenuCoordinates(menu);
	...
	var Page = function Page(_ref) {
	  ...
	  })), !responsiveOpen ? /*#__PURE__*/React.createElement("div", {
	    className: "body"
	  }, /*#__PURE__*/React.createElement("aside", null, /*#__PURE__*/React.createElement(Menu, {
	    path: path,
	    menu: menu,
	...
	var Docs = function Docs(_ref) {
	  ...
	  */
	  ...
	  react.exports.useEffect(function () {
	    ...
	    var elements = [].concat(Array.from(document.getElementsByTagName('h1')), Array.from(document.getElementsByTagName('h2')), Array.from(document.getElementsByTagName('h3')));
	    var nMenu = [];
	...
	var v_1_0_5 = decodeURIComponent(escape(window.atob("")));
	var readmes = {
	  "1.0.5": v_1_0_5
	};
